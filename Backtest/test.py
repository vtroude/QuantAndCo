...
from Strategy.Momentum.tsi_strategy import TSIStrategy
import time
import os
from Strategy.Momentum.utils import prepare_data
...
if __name__ == '__main__':
    ...
    backtesting = Backtest(strategy_df=strategy_df, symbol='EUR_USD', market='forex',
                           interval='1m', start_date=backtest_start_date, end_date=backtest_end_date, leverage=10,
                           fees=0.00007, take_profit=10, stop_loss=-10)
